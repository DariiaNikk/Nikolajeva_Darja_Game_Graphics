...
let baseColor = vec3.fromValues(0.9, 0.8, 0.6);
let ambientLightColor = vec3.fromValues(1.0, 1.0, 1.0);
let numberOfPointLights = 2;
let pointLightColors = [vec3.fromValues(1.0, 1.0, 1.0), vec3.fromValues(1.0, 1.0, 1.0)];
let pointLightInitialPositions = [vec3.fromValues(3, 0, 2), vec3.fromValues(-3, 0, 2)];
